...
4-Chloro-1,2-diaminobenzene contains two replicates, each with five distinct concentrations. The package also contains a tool for visualizing the data at the assay plate level.
