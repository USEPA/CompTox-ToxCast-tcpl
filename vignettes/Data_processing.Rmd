...
output:
  prettydoc::html_pretty:
    ...
    toc_depth: 4
vignette: >
  %\VignetteIndexEntry{3. Data Processing with current version (v3+)}
...
htmlTable(output,
          ...
          rnames = FALSE  ,
          css.cell =  ' padding-bottom: 5px;  vertical-align:top; padding-right: 10px;min-width: 5em ',
          caption="Table 11: Level 5 overwrite (ow) methods for censoring the hitcall in curves fit in the unintended direction."
          )
```
