...
C <- mc3 %>%
  ...
  geom_point(data = dplyr::filter(mc4,spid == "01504209"),
             ...
             col = "darkgoldenrod3",alpha = 0.75,pch = 15)+
  xlab(expression(paste(log[10],"(Concentration) ",mu,"M")))+
  ylab(mc3[,aenm])+
...
D <- mc3 %>%
  ...
  geom_point(data = dplyr::filter(mc4,spid == "01504209"),
             ...
             col = "indianred",alpha = 0.75,pch = 15)+
  xlab(expression(paste(log[10],"(Concentration) ",mu,"M")))+
  ylab(mc3[,aenm])+
...
E <- mc3 %>%
  ...
  geom_point(data = level3_min,aes(x = logc,y = resp),
             pch = 24,col = "blue", bg = "blue",alpha = 0.75)+
  geom_point(data = level3_max,aes(x = logc,y = resp),
             pch = 25,col = "red",bg = "red",alpha = 0.75)+
  xlab(expression(paste(log[10],"(Concentration) ",mu,"M")))+
  ylab(mc3[,aenm])+
