...
![<font style="font-size:15px"><i>Representative Graphs of Flags</i></font>](img/example_flag_plots.jpg){width=650px}
...
```
<center>![<font style="font-size:15px"><i>Plots with parameters: output = "pdf", and multi = TRUE for aeid 80 and spids "TP0001652B01", "01504209", "TP0001652D01", "TP0001652A01", and "1210314466"</i></font>](img/output_pdf.png){width=80%}</center>
...
<center>![<font style="font-size:15px"><i>Plot generated with parameters: output = "jpg" for aeid 80 and spid 01504209</i></font>](img/output_jpg.jpg){width=80%}</center>
...
<center>![<font style="font-size:15px"><i>Plots with parameters: output = "pdf", multi = TRUE, flags = TRUE, and yuniform = TRUE for spids "EPAPLT0108M13", "EPAPLT0108H01", "EPAPLT0108C17", "EPAPLT0106J20" across two different endpoints (aeids 3074 and 3076)</i></font>](img/plot_compare.jpg){width=80%}</center>
...
<center>![<font style="font-size:15px"><i>Single concentration plots with parameters: type = "sc", output = "pdf", and multi = TRUE for spids "MLS", "DMSO", "Tox21_400088", "Tox21_200265", "Tox21_200001", "Tox21_200266" across two different endpoints (aeids 3017 and 3018)</i></font>](img/sc_plot_compare.jpg){width=80%}</center>
...
<center>![<font style="font-size:15px"><i>Plots with parameters: output = "pdf", multi = TRUE, and flags = TRUE for a chemical comparison across five different endpoints (aeids 2642-2646)</i></font>](img/medium_plot_compare.jpg){width=80%}</center>
...
<center>![<font style="font-size:15px"><i>Plot with parameters: output = "jpg", dpi= 100, and flags = TRUE for a endpoint level comparison across 24 samples (aeid 3168)</i></font>](img/large_plot_compare_3168.jpg){width=80%}</center>
...
<center>![<font style="font-size:15px"><i>Comparison plots with parameters: dat = plot_data from tcplPlotLoadData(), output = "pdf", multi = TRUE, and flags = TRUE for comparison of aeid 704 to current database version</i></font>](img/version_compare.jpg){width=80%}</center>
...
<center>![<font style="font-size:15px"><i>API-sourced plot with parameters: output = "jpg" and flags = TRUE for spid "01504209" and aeid 80</i></font>](img/output_jpg.jpg){width=80%}</center>
...
<center>![<font style="font-size:15px"><i>API-sourced plots with parameters: output = "pdf", multi = TRUE, and flags = TRUE for a chemical comparison across five different endpoints (aeids 2642-2646)</i></font>](img/medium_plot_compare.jpg){width=80%}</center>
...
<center>![<font style="font-size:15px"><i>Plots with parameters: output = "pdf" and multi = TRUE for LOEC hit-called-data</i></font>](img/loec_plot.jpg){width=80%}</center>
