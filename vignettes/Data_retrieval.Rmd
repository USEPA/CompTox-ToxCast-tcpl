...
# Data Retrieval
This vignette describes how the user can retrieve data from the ToxCast databases using tcpl. Listed below are case examples that extract summary information about the chemical, *Bisphenol A*, and  the assay, *NVS_NR_hTRa*. The multiple concentration table for level 5 can be downloaded from the publicly available ToxCast data https://www.epa.gov/chemical-research/exploring-toxcast-data-downloadable-data. 

## A. Using Tcpl
We illustrate here the necessary steps for extracting information about *Bisphenol A* using tcpl.
