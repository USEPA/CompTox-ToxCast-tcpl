...
# and map additional annotation information
sc1_fmtd <- tcplPrepOtpt(
  tcplLoadData(
    lvl = 1, # data level
  ...
  ids = c('dsstox_substance_id','acnm','asnm') # additional annotation fields
)
```
...
# Load methods for multiple concentration data processing for select aeids
