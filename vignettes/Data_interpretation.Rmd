...
An activity concentration is the estimated concentration inducing a specified level of response (activity). A common potency metric used from tcpl is the activity concentration at 50% of maximal activity, or **AC50**. All versions of tcpl output the activity concentrations as described in Table 2. 
